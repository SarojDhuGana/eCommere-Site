    ...
    <div className="bg-white">
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                ...
                                'relative z-10 flex items-center border-2 outline-none justify-center text-sm font-medium transition-colors duration-200 ease-out border-none'
                              )}
                            >
                              {category.name}
                              <span
      ...
      <main className="mx-auto mt-8 max-w-2xl px-4 pb-16 sm:px-6 sm:pb-24 lg:max-w-7xl lg:px-8">
        <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
          ...
          {/* Image gallery */}
          {/* <div12 className="mt-8 lg:col-span-7 lg:col-start-1 lg:row-span-3 lg:row-start-1 lg:mt-0">
