...
export default function Footer() {
  return (
    <footer className="bg-gray-200 grid grid-cols-1 md:col-span-1 md:pl-2 lg:justify-center md:px-10 sm:-pl-10" aria-labelledby="footer-heading">
                ...
                <div className="flex space-x-6 mt-4">
                  {navigation.social.map((item) => (
                    <a key={item.name} href={item.href} className="text-black py-4 ">
                      ...
                      <item.icon className="h-8 w-8 py-1 ring-white border-spacing-2 hover:ring bg-gray-100 rounded-full" aria-hidden="true" />
                    </a>
                  ))}
                </div>
                ...
                <div className="md:grid md:grid-cols-1 md:gap-8 max-lg:my-2 max-sm:grid-cols-">
                  <div className="">
                    ...
                    <div className="grid grid-cols-4 gap-3 max-md:grid-cols-2 max-sm:grid-cols-1">
                      ...
                      <img
                        src="path-to-certification-image-1.svg" // Replace with your certification image path
                        alt="Certification Image 1"
                      />
                      <img
                        src="path-to-certification-image-2.svg" // Replace with your certification image path
                        alt="Certification Image 2"
                      />
                      <img
                        src="path-to-certification-image-3.svg" // Replace with your certification image path
                        alt="Certification Image 3"
                      />
                      <img
                        src="path-to-certification-image-4.svg" // Replace with your certification image path
                        alt="Certification Image 4"
                      />
                    </div>
                  </div>
